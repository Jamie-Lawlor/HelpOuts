...
(3, 'John Johnson', 'johnjohnson@gmail.com', 'scrypt:32768:8:1$HGyAqImmePvDxpyt$a5f9fba484d19c468001450f5eff5721110daa6d042d0a5930cac070cb7783f34d1c7e0e87396d0a008381f2aba2bd3e09898e77b8e90f279a6a121d8c810fdc', 'chairperson', 'Dundalk', 'Chairperson', 0, NULL, NULL,  NULL, FALSE, 0.0, 3),
(4, 'Daisy Johnson', 'daisyjohnson@gmail.com', 'scrypt:32768:8:1$HGyAqImmePvDxpyt$a5f9fba484d19c468001450f5eff5721110daa6d042d0a5930cac070cb7783f34d1c7e0e87396d0a008381f2aba2bd3e09898e77b8e90f279a6a121d8c810fdc', 'chairperson', 'Dundalk', 'Local Helper', 4, NULL, NULL,  NULL, FALSE, 0.0, 4),
...
(6, 'Kerrie McLoughlin', 'mullaghbawnchairperson@gmail.com', 'scrypt:32768:8:1$lpzYIhx4dW5ewbY0$ea0c81ecc72b7298ed87f99fb535dc46f4777d4232c34da22a5705afc596b55f7aee83ec65bed7d7b6b3792d1b58508813cb15f4a6a388a74276048327c69839', 'chairperson', 'Monaghan', 'Helper', 0, '-----BEGIN RSA PRIVATE KEY-----
...
(7, 'Mens Shed Volunteer 1', 'mshedvolunteer1@gmail.com', 'scrypt:32768:8:1$lpzYIhx4dW5ewbY0$ea0c81ecc72b7298ed87f99fb535dc46f4777d4232c34da22a5705afc596b55f7aee83ec65bed7d7b6b3792d1b58508813cb15f4a6a388a74276048327c69839', 'helper', 'Monaghan', 'Local Helper', 0, '-----BEGIN RSA PRIVATE KEY-----
...
-----END PUBLIC KEY-----', NULL, FALSE, 0.0, 1),
...
VALUES
(1, 'Install park benches and picnic tables','Help assemble and install benches/tables in the new park. Basic tools helpful. Outdoor work.','Benches install', 'environment', 'A', 5, 'Dundalk', CURRENT_TIMESTAMP, '2026-07-01', '2026-07-01',1),
(2, 'Repair and paint perimeter fencing','Sand, repair and repaint park fencing to improve safety and appearance. PPE recommended.','Fence paint', 'general_maintenance', 'A', 6, 'Dundalk', CURRENT_TIMESTAMP, '2026-07-05', '2026-07-05',1),
(3, 'Outdoor lighting check and minor fixes','Check existing lighting points around the park area and complete minor electrical fixes where safe.', 'Lighting', 'safety', 'D', 9, 'Dundalk', CURRENT_TIMESTAMP, '2026-07-10', '2026-07-10',1),
(4, 'Build a small raised planter bed','Construct a raised wooden planter bed for flowers near the entrance. Carpentry help needed.','Planter bed', 'construction', 'A', 5, 'Dundalk', CURRENT_TIMESTAMP, '2026-07-12', '2026-07-12',1),
(5, 'Assemble raised garden beds', 'Help construct and install wooden raised beds for the new community garden.', 'Garden beds', 'construction', 'A', 6, 'Dundalk', CURRENT_TIMESTAMP, '2026-06-10', '2026-06-10', 5),
(6, 'Plant flowers and vegetables', 'Assist with planting vegetables and flowers in the restored garden.', 'Planting', 'environment', 'A', 4, 'Dundalk', CURRENT_TIMESTAMP, '2026-07-15', '2026-07-15', 5),
(7, 'Repair roof panels', 'Replace damaged roof panels and secure new fittings on the community hall.', 'Roof repair', 'construction', 'A', 10, 'Dundalk', CURRENT_TIMESTAMP, '2026-06-12', '2026-06-12', 6),
(8, 'Electrical lighting inspection', 'Inspect and repair outdoor lighting around the hall entrance.', 'Lighting check', 'safety', 'A', 5, 'Dundalk', CURRENT_TIMESTAMP, '2026-07-13', '2026-07-13', 6),
(9, 'Collect litter and recycling', 'Walk through assigned streets collecting litter and recyclables.', 'Town clean up', 'environment', 'A', 10, 'Ardee', CURRENT_TIMESTAMP, '2026-06-05', '2026-06-05', 7),
(10, 'Sort collected waste', 'Help organise waste into recycling and disposal categories.', 'Waste sorting', 'environment', 'A', 1, 'Ardee', CURRENT_TIMESTAMP, '2026-08-05', '2026-08-05', 7),
(11, 'Build wooden seating benches', 'Construct wooden benches for the outdoor seating area.', 'Bench build', 'construction', 'A', 9, 'Dundalk', CURRENT_TIMESTAMP, '2026-07-20', '2026-07-20', 8),
(12, 'Sand and treat wooden surfaces', 'Sand and weatherproof newly built seating structures.', 'Wood treatment', 'general_maintenance', 'A', 3, 'Dundalk', CURRENT_TIMESTAMP, '2026-07-21', '2026-07-21', 8),
(13, 'Posting t-shirts','Organise the posting of t-shirts for people in Monaghan who have registered for the event','Posting t-shirts','social_and_events', 'NA', 4, 'Monaghan', CURRENT_TIMESTAMP, '2026-07-17', '2026-08-09', 9),
(14, 'Setup banners','Setting up banners for the event','Setup banners','environment', 'NA', 5, 'Monaghan', CURRENT_TIMESTAMP, '2026-07-09', '2026-07-09', 9),
(15,'Tea and coffee stand','Organise tea and coffee stand after the walk is finished','Tea & Coffee','social_and_events', 'NA', 6, 'Monaghan', CURRENT_TIMESTAMP, '2026-08-17', '2026-09-09', 9),
(16, 'Stewards','Give people directions to the correct path so no one gets lost along the walk','Stewards','social_and_events', 'NA', 7, 'Monaghan', CURRENT_TIMESTAMP, '2026-08-18', '2026-08-19', 9);

...
Revision ID: c240aa6c3443
Revises: 
Create Date: 2025-12-22 12:45:24.868009
...
def upgrade():
    ...
    sa.Column('maximum_helpers', sa.Integer(), nullable=False),
    sa.Column('minimum_helpers', sa.Integer(), nullable=False),
    ...
    sa.Column('helpee_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['helpee_id'], ['users.id'], ),
